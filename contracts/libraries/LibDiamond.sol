...
library LibDiamond {
    ...
    function addFunctions(address _facetAddress, bytes4[] memory _functionSelectors) internal {
        ...
        for (uint256 selectorIndex; selectorIndex < _functionSelectors.length; selectorIndex++) {
            ...
            require(oldFacetAddress == address(0), 'LibDiamondCut: Cannot add function that already exists');
    ...
    function removeFunctions(address _facetAddress, bytes4[] memory _functionSelectors) internal {
       // require(_functionSelectors != diamondCutSelector , 'diamonCut function is immutable');
        ...
        for (uint256 selectorIndex; selectorIndex < _functionSelectors.length; selectorIndex++) {
            ...
            require(oldFacetAddressAndSelectorPosition.facetAddress != address(0), 'LibDiamondCut: Cannot remove function that does not exist');
            // can't remove immutable functions -- functions defined directly in the diamond
            require(oldFacetAddressAndSelectorPosition.facetAddress != address(this), 'LibDiamondCut: Cannot remove immutable function.');
